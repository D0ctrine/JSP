...
<body>
    <div class="mainP">
        <h1>My Story</h1>
        <hr>
        <form action="member_chk.jsp" method=post>
        <table border=0 align=center width='1024' class="txt" align=center >
            ...
            <tr>   
                ...
                <td class="formEle" colspan=4>
                    <input type="text" size="20" name="ipwd1" maxlength="8">
                </td>                      
            </tr>
            <tr> 
                 <td width=100><span>비밀번호확인</span></td>  
                <td class="formEle" colspan=4>
                    <input type="text" size="20" name="ipwd2" maxlength="8">
                </td>                   
            </tr>
            <tr>   
                <td colspan=5>
